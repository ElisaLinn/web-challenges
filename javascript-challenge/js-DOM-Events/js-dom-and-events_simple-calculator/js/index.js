...
const subtract = document.querySelector("[data-js=substract]");
...
const increaseByOne = document.querySelector("[data-js=incease-by-one]");
const increaseByFive = document.querySelector("[data-js=incease-by-five]");
