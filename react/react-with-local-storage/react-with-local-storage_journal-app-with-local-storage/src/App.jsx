...
function App() {
  const [entries, setEntries ] = useLocalStorageState('journal-entries', {defaultValue: initialEntries});
  const [filter, setFilter ] = useLocalStorageState('filter-state', {defaultValue: "all"}); // "all" or "favorites"
